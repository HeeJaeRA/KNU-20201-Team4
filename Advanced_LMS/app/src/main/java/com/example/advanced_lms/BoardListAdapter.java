...
public class BoardListAdapter extends BaseAdapter {
    ...
    private ArrayList<BoardListItem> listViewItemList = new ArrayList<>() ;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView descTextView = (TextView) convertView.findViewById(R.id.BoardDescription) ;

        // Data Set(listViewItemList)에서 position에 위치한 데이터 참조 획득
        BoardListItem listViewItem = listViewItemList.get(position);
