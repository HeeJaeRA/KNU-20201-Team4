...
public class CommentListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView CommentWriterTextView = (TextView) convertView.findViewById(R.id.Tv_CommentWriter) ;
        TextView CommentTimeTextview = (TextView) convertView.findViewById(R.id.Tv_CommentTime) ;
        ...
        // 아이템 내 각 위젯에 데이터 반영
        CommentWriterTextView.setText(listViewItem.getWriter());
        CommentTimeTextview.setText(listViewItem.getTime());
    ...
    public void addItem(String writer, String time, String comment) {
